...
<form class="form-group">
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <input type="text" class="form-control" id="inputAlamat" placeholder="Sesuai Kartu Keluarga" style="height: 100px">
    </div>

    <div class="col-md-6">
      <label for="pasFoto" class="form-label">Masukkan Pas Foto</label>
      <input class="form-control" type="file" id="pasFoto" style="height: 100px">
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="col-sm">
      ...
      <input type="tel" class="form-control" id="inputKontak" name="inputKontak" placeholder="Masukkan nomor kontak Anda" pattern="[0-9]{10,12}" minlength="10" maxlength="12">
  ...
  <div class="row">
    ...
    <div class="col-sm">
      ...
      <input class="form-control" type="file" id="fileKK" style="height: 100px">
    </div>
  </div>
